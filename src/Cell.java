...
public class Cell
{
	...
	private static String[] filenames = {"BlueChip.png", "GreenChip.png", "PurpleChip.png", "RedChip.png", "YellowChip.png", "CharcoalChip.png"};
	private static String[] cellColors = {"Blue","Green","Purple","Red","Yellow","Charcoal"};
...
// ===================================  OVERRIDDEN OBJECT METHODS ==============================
	...
	{
		return "Cell: "+marker+": color:"+cellColors[colorID]+" ("+getX()+","+getY()+")";
	}
